...
fn main() {
    ...
    if !is_mobile {
        ...
        let bin_name = format!("serein_server-{}{}", target, ext);
    ...
    if is_mobile {
        ...
        let lib_name = if target.contains("windows") { "serein.lib" } else { "libserein.a" };
        ...
        println!("cargo:rustc-link-lib=static=serein");
